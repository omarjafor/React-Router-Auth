...
const Register = () => {
    ...
    const handleRegister = e => {
        ...
        if (password.length < 6) {
            setRegistError('Password Should be at least 6 charecter');
            return;
        } else if (!/[A-Z]/.test(password)) {
            setRegistError('Your Password Should Have at least one uppercase');
            return;
        } else if (!accepted) {
            setRegistError('Please Accept Our Terms & Conditions');
            return;
        }
